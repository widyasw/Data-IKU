                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="dropdown relative">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-7.print', ['type' => 'pdf']) }}" target="_blank"
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-7.print', ['type' => 'pdf', 'preview' => true]) }}"
                                            target="_blank"
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                                    dark:hover:text-white">
                                            Preview PDF
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-7.print', ['type' => 'excel']) }}" target="_blank"
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                                    dark:hover:text-white">
                                            Download Excel
                                        </a>
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($items as $key => $item)
                                            <tr>
                                                ...
                                                <td class="table-td">{{ $item->credit_hours }}</td>
                                                <td class="table-td">{{ $item->select_list->name ?? '' }}</td>
                                                <td class="table-td">{{ $item->output }}</td>
                                                <td class="table-td">
                                                    <a href="{{ route('show_file', ['path' => 'iku-7', 'id' => $item->id, 'preview' => true]) }}"
                ...
                <div class="modal-dialog modal-xl relative w-auto pointer-events-none">
                    <div
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                            ...
                            <!-- Modal body -->
                            <div>
                                <form id="form-el" action="{{ route('admin.iku-7.store') }}" method="POST"
...
@push('js')
    ...
    <script>
        ...
        function reset_form() {
            $("#form-el").attr("action", "{{ route('admin.iku-7.store') }}");
