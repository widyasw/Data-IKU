                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="dropdown relative">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-3.print', ['type' => 'pdf']) }}" target="_blank"
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-3.print', ['type' => 'pdf', 'preview' => true]) }}"
                                            target="_blank"
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                                    dark:hover:text-white">
                                            Preview PDF
                                    ...
                                    <li>
                                        <a href="{{ route('admin.iku-3.print', ['type' => 'excel']) }}" target="_blank"
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                                    dark:hover:text-white">
                                            Download Excel
                                        </a>
